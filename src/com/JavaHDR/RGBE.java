 ...
 * developed by Greg Ward. It handles the conversions between rgbe and pixels
 * consisting of floats. The data is assumed to be an array of floats. By
 * default there are three floats per pixel in the order red, green, blue.
 * (RGBE_DATA_??? values control this.) Only the mimimal header reading and
 * writing is implemented. Each routine does error checking and will return a
 * status value as defined below. This code is intended as a skeleton so feel
 * free to modify it to suit your needs.
 * <P>
 * <p/>
 ...
 * <p/>
 * Source:
 * https://java.net/projects/jogl-demos/sources/svn/content/trunk/src/demos/hdr/RGBE.java
 */
public class RGBE {
	 ...
	 * ldexp(col+0.5,exp-(128+8)). However we wanted pixels in the range [0,1] to
	 * map back into the range [0,1].
	 */
	 ...
	 * copysign(x,y) returns a value with the magnitude of x and with the sign bit
	 * of y.
	 */
